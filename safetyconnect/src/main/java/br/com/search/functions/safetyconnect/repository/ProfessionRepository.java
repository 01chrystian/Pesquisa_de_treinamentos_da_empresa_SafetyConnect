...
public interface ProfessionRepository extends JpaRepository<Profession,Long>{
	...
	@Query(nativeQuery=true, value = "update tb_profession.description, tb_profession.cbo"
			+ "from tb_profession"
			+ "where LOWER(tb_profession.description) = :description or tb_profession.cbo = :cbo")
	Optional<Profession> professionOfUpdate(String description, String cbo);
